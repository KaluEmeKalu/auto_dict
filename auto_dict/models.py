...
class Word(Model):
    ...
    origin = CharField(max_length=980, default="No Origin Entry")
    part_of_speech = CharField(max_length=180, null=True, blank=True, default="No Part Of Speech Entry")
    syllables = CharField(max_length=980, default="No Syllables Entry")
    synonyms = CharField(max_length=980, default="No Synonyms Entry")
    antonyms = CharField(max_length=980, default="No Antonyms Entry")
    other_usages = CharField(max_length=980, null=True, blank=True, default="No Other Usages Entry")
    pronunciation = CharField(max_length=980, null=True, blank=True, default="No Pronunciation Entry")
    tags = CharField(max_length=980, default="No Tags Entry")
